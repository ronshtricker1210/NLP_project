...
benchmark. \emph{Eligible words} are those the generator may corrupt, i.e. after
removing protected spans (numbers, \LaTeX{}), single-character words and fifteen
function words; the typo rate applies to these, so typos @ $r$ equals $r$ times the
eligible count. Typo counts are averaged over the three real-word ratios: for a fixed
